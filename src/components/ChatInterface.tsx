        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="px-4 py-2 border-t border-border bg-card/70 flex items-center justify-between gap-2 max-w-3xl mx-auto text-xs">
            <div className="flex items-center gap-1 bg-muted/60 p-1 rounded-lg border border-border/40 font-sans">
              {/* Fast Scan Button with Hover Tooltip */}
              <Tooltip>
              ...
              {/* Deep Audit Button with Hover Tooltip */}
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    type="button"
                ...
                <TooltipContent side="top" className="max-w-xs bg-card border-border p-3 text-xs shadow-xl space-y-1">
                  <div className="flex items-center gap-1.5 font-bold text-blue-400 text-xs">
                    ...
                    <span>Deep Audit (Claude Opus 5)</span>
                  </div>
                  <p className="text-muted-foreground text-[11px] leading-relaxed">
                    <strong>Speed:</strong> ~10–20 seconds.<br />
                    <strong>Best for:</strong> Multi-pass CIS Benchmark audits, IAM privilege escalation path mapping, nested security group cross-references, and historical CloudTrail event correlation.
                  </p>
                </TooltipContent>
              </Tooltip>
            </div>
