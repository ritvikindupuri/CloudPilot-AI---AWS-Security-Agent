            ...
            <div className="space-y-4 my-4">
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  ...
                  {tourStep === 8 && "Lists all event response policies powered by Guardian Automations (real-time CloudTrail EventBridge webhooks), allowing you to activate, pause, or edit policy triggers."}
                  {tourStep === 9 && "Lists cost rules powered by Guardian Automations background scans (e.g. flagging idle EC2s or unattached EBS volumes) for proactive cost optimization."}
                  {tourStep === 10 && "Displays a breakdown of baseline resources, unresolved drift counts, and snapshot timestamps generated by Guardian Automations background scans."}
